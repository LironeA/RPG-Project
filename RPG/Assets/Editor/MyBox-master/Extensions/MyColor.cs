...
namespace MyBox
{
    public static class MyColor
    {
        ...
        public static Color RandomDim =>
            new Color(Random.Range(.4f, .6f), Random.Range(.4f, .8f), Random.Range(.4f, .8f));

        public static Color RandomColor =>
            new Color(Random.Range(.1f, .9f), Random.Range(.1f, .9f), Random.Range(.1f, .9f));
        ...
        {
            ColorUtility.TryParseHtmlString(source, out var res);
            return res;
        }
    }
}