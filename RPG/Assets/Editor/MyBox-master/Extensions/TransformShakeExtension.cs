...
namespace MyBox
{
    ...
    public static class TransformShakeExtension
    {
            ...
            bool useUnscaledTime = true, bool fadeBounds = false)
        {
            ...
            var coroutine = TransformShakeCoroutine(transform, time, shakeBounds, useUnscaledTime, fadeBounds)
                .StartCoroutine();
            ...
            bool useUnscaledTime, bool fadeBounds)
        {
            ...
            while (shakeTime < 0 || elapsed < shakeTime)
            {
                ...
                var elapsedRate = 1 - elapsed / shakeTime;

                var xShake = Random.value * bounds * 2 - bounds;
                var yShake = Random.value * bounds * 2 - bounds;
