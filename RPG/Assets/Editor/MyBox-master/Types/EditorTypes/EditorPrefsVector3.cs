...
namespace MyBox.EditorTools
{
    ...
    public class EditorPrefsVector3 : EditorPrefsType
    {
        ...
        {
            get => new Vector3(EditorPrefs.GetFloat(Key + "x", 0), EditorPrefs.GetFloat(Key + "y", 0),
                EditorPrefs.GetFloat(Key + "z", 0));
            set
            {
        ...
        public static EditorPrefsVector3 WithKey(string key)
        {
            return new EditorPrefsVector3(key);
        }
    }
}
#endif