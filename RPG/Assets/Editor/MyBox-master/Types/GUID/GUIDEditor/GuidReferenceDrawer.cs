...
namespace MyBox.Internal
{
    ...
    public class GuidReferenceDrawer : PropertyDrawer
    {
        ...
        private GUIContent sceneLabel =
            new GUIContent("Containing Scene", "The target object is expected in this scene asset.");

        private GUIContent clearButtonGUI = new GUIContent("Clear", "Remove Cross Scene Reference");
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            var arraySize = guidProp.arraySize;
            ...
            var currentGuidComponent = currentGO != null ? currentGO.GetComponent<GuidComponent>() : null;
            ...
            if (currentGuid != System.Guid.Empty && currentGuidComponent == null)
            {
                ...
                var clearButtonRect = new Rect(guidCompPosition);
                clearButtonRect.xMin = guidCompPosition.xMax;
                clearButtonRect.xMax += buttonWidth;

                if (GUI.Button(clearButtonRect, clearButtonGUI, EditorStyles.miniButton)) ClearPreviousGuid();
            }
            else
            {
            ...
            if (currentGuidComponent != null && component == null) ClearPreviousGuid();
