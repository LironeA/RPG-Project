...
namespace MyBox
{
    ...
    public class TransformData
    {
        ...
        public static TransformData FromTransform(Transform transform, bool savePosition = true,
            bool saveRotation = true, bool saveScale = true)
        {
...
namespace MyBox.Internal
{
    ...
    public class TransformDataDrawer : PropertyDrawer
    {
        private static GUIContent PositionIcon =>
            _positionIcon ?? (_positionIcon =
                new GUIContent(EditorGUIUtility.IconContent("MoveTool").image, "Save Position"));

        private static GUIContent _positionIcon;

        private static GUIContent RotationIcon =>
            _rotationIcon ?? (_rotationIcon =
                new GUIContent(EditorGUIUtility.IconContent("RotateTool").image, "Save Rotation"));
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            bRect.width = 30;
            savePosition.boolValue =
                GUI.Toggle(bRect, savePosition.boolValue, PositionIcon, EditorStyles.miniButtonLeft);
            bRect.x += 30;
            saveRotation.boolValue =
                GUI.Toggle(bRect, saveRotation.boolValue, RotationIcon, EditorStyles.miniButtonMid);
            bRect.x += 30;
