    ...
    public class UIRelativePosition : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (!SetX.IsSet && !SetY.IsSet)
                Debug.LogError(name + " Caused: Check SetX and/or SetY for RelativePosition to work", this);
        }
        ...
        private void LateUpdate()
        {
            ...
            var finalPosition = new Vector2(SetX.IsSet ? (int) x : localPosition.x,
                SetY.IsSet ? (int) y : localPosition.y);
