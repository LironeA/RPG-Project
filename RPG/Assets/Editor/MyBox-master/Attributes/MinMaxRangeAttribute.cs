...
namespace MyBox.Internal
{
    ...
    public class MinMaxRangeIntAttributeDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            var isInt = minProp.propertyType == SerializedPropertyType.Integer;

            var minValue = isInt ? minProp.intValue : minProp.floatValue;
            var maxValue = isInt ? maxProp.intValue : maxProp.floatValue;
            var rangeMin = rangeAttribute.Min;
            var rangeMax = rangeAttribute.Max;
