...
namespace MyBox.Internal
{
    ...
    public class ConditionalFieldAttributeDrawer : PropertyDrawer
    {
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            _toShow = ConditionalFieldUtility.PropertyIsVisible(propertyToCheck, conditional.Inverse,
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            void TryUseAttributeDrawer()
            {
                ...
                catch (Exception e)
                {
                    ...
                    LogWarning("Unable to use Custom Attribute Drawer " + _customAttributeDrawer.GetType() + " : " + e,
                        property);
                }
            }
        ...
        private void Initialize(SerializedProperty property)
        {
            ...
            void TryGetCustomAttributeDrawer()
            {
                ...
                var secondAttribute = (PropertyAttribute) fieldInfo
                ...
                var customAttributeData = fieldInfo.GetCustomAttributesData()
                    .FirstOrDefault(a => a.AttributeType == secondAttribute.GetType());
                ...
                try
                {
                    ...
                    var attributeField = customAttributeDrawerType.GetField("m_Attribute",
            ...
            void TryGetCustomTypeDrawer()
            {
                ...
                var attributeField =
                    fieldDrawerType.GetField("m_Attribute", BindingFlags.Instance | BindingFlags.NonPublic);
                if (attributeField != null) attributeField.SetValue(_customTypeDrawer, attribute);
                var fieldInfoField =
                    fieldDrawerType.GetField("m_FieldInfo", BindingFlags.Instance | BindingFlags.NonPublic);
    ...
    public static class ConditionalFieldUtility
    {
        ...
        public static SerializedProperty FindRelativeProperty(SerializedProperty property, string propertyName)
        {
            ...
            if (nestedProperty == null)
            {
                ...
                var who = "Property <color=brown>" + arrayProp.name + "</color> in object <color=brown>" + target.name +
                          "</color> caused: ";
                var warning = who +
                              "Array fields is not supported by [ConditionalFieldAttribute]. Consider to use <color=blue>CollectionWrapper</color>";
        ...
        public static bool BehaviourPropertyIsVisible(UnityEngine.Object obj, string propertyName,
