        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            if (property.propertyType != SerializedPropertyType.String)
            {
                ...
                EditorGUI.LabelField(position,
                    new GUIContent("", "[CharacterRangeAttribute] used with non-string property"));
            }
            else
            {
                ...
                var ifMatch = mode == CharacterRangeMode.WarningIfAny;
                var ifNotMatch = mode == CharacterRangeMode.WarningIfNotMatch;
                var anyFiltered = filteredCharacters.Any();
                var warn = ifMatch && anyFiltered || ifNotMatch && anyFiltered;
