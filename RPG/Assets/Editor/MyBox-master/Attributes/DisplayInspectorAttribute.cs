...
namespace MyBox.Internal
{
    ...
    public class DisplayInspectorAttributeDrawer : PropertyDrawer
    {
        ...
        private SerializedObject GetTargetSO(Object targetObject)
        {
            ...
            if (_targets.ContainsKey(targetObject))
            {
        ...
        {
            var notValidType = property.propertyType != SerializedPropertyType.ObjectReference;
            if (notValidType)
            {
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            var height = ((DisplayInspectorAttribute) attribute).DisplayScript
                ? EditorGUI.GetPropertyHeight(property) + 4
                : 0;
