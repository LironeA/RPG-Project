...
namespace MyBox.Internal
{
    ...
    {
        private static readonly Dictionary<AutoPropertyMode, Func<MyEditor.ObjectField, Object[]>>
            MultipleObjectsGetters
        ...
        private static void FillProperty(MyEditor.ObjectField property)
        {
            ...
            Debug.LogError(
                $"{property.Context.name} caused: {property.Field.Name} is failed to Auto Assign property. No match",
                property.Context);
        }
    }
}
