...
namespace MyBox.Internal
{
    ...
    public class SearchableEnumAttributeDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            var id = GUIUtility.GetControlID(idHash, FocusType.Keyboard, position);
    ...
    public class SearchablePopup : PopupWindowContent
    {
        ...
        private void DrawSearch(Rect rect)
        {
            ...
            var newText = GUI.TextField(searchRect, list.Filter, SearchBox);
        ...
        private void HandleKeyboard()
        {
            if (Event.current.type == EventType.KeyDown)
            {
                ...
                if (Event.current.keyCode == KeyCode.Escape) EditorWindow.focusedWindow.Close();
            }
        }
